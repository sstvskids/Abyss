...
for _, v in pairs(game.CoreGui:GetChildren()) do
    if v.Name == "dark_UI" then return end
end
...
function addMaid(obj)
    obj.Connections = {}
    function self:Clean(func)
...
function Library:Create(table)
    ...
    function tabHandler:Tab(name)
        ...
        --// Event
        self:Clean(main1.MouseButton1Click:Connect(function()
        ...
        function ElementHandler:Slider(text, default, min, max, callback) -- slider stuff mainly not made by me
            ...
            self:Clean(slider.MouseButton1Down:connect(function()
    ...
    --// Drag - not by me
    self:Clean(main.MouseEnter:Connect(function()
    ...
    self:Clean(game.CoreGui['dark_UI'].main.tabContainer.ChildAdded:Connect(function()
